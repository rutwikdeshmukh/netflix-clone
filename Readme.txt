...
aws ssm send-command --document-name "AWS-RunShellScript" --targets "Key=instanceids,Values=i-0d8d9a96e0cbf58c9" --parameters="commands","sudo cat /var/lib/jenkins/secrets/initialAdminPassword" --output text --query "Command.CommandId" --profile AWSTA
